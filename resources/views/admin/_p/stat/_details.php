<div class="tab-pane" id="tab2">
    ...
    <a href="#" data-href="<?php print url('').'/lmr_access/statApi/'.$p->item->id; ?>" class="statApi">Стягнути дані з API</a><br/><br/>
...
//          ($p->item->type==0)?
              ...
              print '<input class="btn btn-primary saveSubForm saveCompose2" data-f="stat_details"  data-id="'.$p->id.'" value=" Зберегти дані">';
